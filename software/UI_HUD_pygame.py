...
def teken_midden_paneel(surface):
    ...
    try:
        auto_image = pygame.image.load('auto.png').convert_alpha() #extra visualisation, but for this project car doesn't have to be downloaded
    except:
        auto_image = pygame.Surface((150, 80), pygame.SRCALPHA)
        auto_image.fill((200, 200, 200, 255))
        
    auto_rect = auto_image.get_rect(center=(center_x, SCREEN_HEIGHT - 170))
